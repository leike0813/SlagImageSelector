...
class Ui_GroundTruthConverterWidget(object):
    def setupUi(self, GroundTruthConverterWidget):
        ...
        GroundTruthConverterWidget.resize(400, 200)
        ...
        self.gridLayout.addWidget(self.kernelShapeComboBox, 0, 3, 1, 1)

        self.label_5 = QLabel(self.convertOptionGroupBox)
        self.label_5.setObjectName(u"label_5")

        self.gridLayout.addWidget(self.label_5, 0, 0, 1, 1)

        self.categoryComboBox = QComboBox(self.convertOptionGroupBox)
...
"(1\u4ee3\u8868\u4e0d\u6269\u5c55)", None))
        ...
        self.label_5.setText(QCoreApplication.translate("GroundTruthConverterWidget", u"\u8f6c\u6362\u7c7b\u522b", None))
